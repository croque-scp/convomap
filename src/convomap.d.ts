...
declare global {
   ...
   * @property modifications - Relationships from modifiers.
   ...
   */
  type CMActionFunctionArgumentType = {
    actionFunctionId: number
    name: string
    type: string
    optional: boolean
   ...
   */
  type CMActionTermFunctionArgument = {
    actionTermId: number
  } & CMSortable
   ...
   * from the stack.
   * @property conditionFunctionId - The ID of the condition function
   * represented by this term.
   */
  type CMConditionTerm = {
    conditionId: number
  ...
  /**
   * A custom condition function either defined by the user or created by
   * default by Convomap.
   *
   ...
   * arguments must precede optional arguments, if there are any.
   */
  type CMConditionFunctionArgumentType = {
   ...
   * TODO Work out how to indicate the value of the argument
   */
  type CMConditionTermFunctionArgument = {
   ...
   */
  type CMConditionOperator = "AND" | "OR" | "NOT" | "EVER"
}
